...
系统的数据库表如下所示(与后续功能介绍中页面的功能选项一一对应，展示了较重要的几张表)：
...
​	session1、2随着系统的使用而改变，登陆时写入登陆用户数据，注销时从表中删除用户数据，可以不足五条记录
...
数据库备份
    ...
    mongodump -h 127.0.0.1:27017 -d 190110910802 -o /home/dump/

恢复

mongorestore -h 172.21.2.236:27017 -d 190110910802 --dir ~/dump/190110910802

数据库备份的时间有点长，需要耐心等待，并不是备份文件夹是空的，而是还在备份，等待一段时间后数据文件就会出现！

 scp -r clrcjj-final/ osuser@172.21.2.236:~/190110910802
